...
function Proyectos(){
    return(
        ...
        <>
         ...
         <section className="py-5">
             <div className="container px-5 mb-5">
                 <div className="text-center mb-5">
                     <h1 className="display-5 fw-bolder mb-0"><span className="text-gradient d-inline">Projectos</span></h1>
                 </div>
         ...
         <section className="py-5 bg-dark bg-gradient text-white">
             <div className="container px-5 my-5">
                 <div className="text-center">
                     <h2 className="display-4 fw-bolder mb-4">Trabajemos juntos</h2>
                     <Link className="btn btn-outline-light btn-lg px-5 py-3 fs-6 fw-bolder" to="/contact">Contactame</Link>
                 </div>
             </div>
         </section>
     </main>
